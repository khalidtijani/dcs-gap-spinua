...
## Only basic Linux/Unix commands and GMT are used.
##
...
##        [$7] : ftp_link_1 (optional)
##        [$8] : ftp_link_2 (optional)
##        [$9] : ftp_user   (optional)
...
do
  ...
  do
    ...
    then
      ...
      for dir in $dir_list
        do
        remotedir=srtm/version2/${srtm}/${dir}
        echo "Checking" ${remotedir} "..."
        ftp_call $remotedir ${file}.zip $ftp_link_1 $ftp_user $ftp_pass
...
do
  ...
  do
    ...
    then
      # download the tile
      remotedir=srtm/version2/SRTM30/$file2
      ftp_call $remotedir ${file2}.dem.zip $ftp_link_2 $ftp_user $ftp_pass
...
echo -e '# Import the section(s) that is/are necessary to your processing step-up.\n' >> $input_doris
