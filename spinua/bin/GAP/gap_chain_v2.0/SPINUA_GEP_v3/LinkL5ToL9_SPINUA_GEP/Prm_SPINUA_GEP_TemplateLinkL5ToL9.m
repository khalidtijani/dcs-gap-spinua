...
GLUE_CODE_SETTINGS.EnablePSReports = 1;  
...
%    SPSC_SettingStr.RP.SparseCropAbsFLPixel  = SS_CalibrCoordFirstLastPixel(1)+[1 300];
   ...
   SPSC_SettingStr.RP.CropAbsFLPixel  = SS_CalibrCoordFirstLastPixel; 
      ...
      SPSC_SettingStr.RP.NIterPerPatch    = 2; 
   SPSC_SettingStr.RP.MinImgsPerRun    = [6 9 12]; 
   ...
   SPSC_SettingStr.RP.EnablePSReports = 1; 
